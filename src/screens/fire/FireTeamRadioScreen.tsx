/**
 * ✅ FIRE DEPARTMENT - TEAM RADIO SCREEN
 * Fire crew grid with direct communication
...
interface CrewMember {
  ...
  name: string;
  badge: string;
  status: 'on-scene' | 'responding' | 'available' | 'standby';
  distance: string;
  lastSeen: string;
  bgColor: string;
}
...
const CHAT_MESSAGES: ChatMessage[] = [
  {
    id: '1',
    senderId: '1',
    senderName: 'Capt. Johnson',
    type: 'text',
    content: 'Fire is under control. Requesting second unit for mop-up operations.',
    time: '14:32',
  },
  {
    id: '2',
    senderId: '2',
    senderName: 'Mark Brown',
    type: 'audio',
  ...
  },
  {
    ...
    senderName: 'System',
    type: 'system',
    content: 'Engine F2 deployed to scene',
    time: '14:34',
  },
];

const FireTeamRadioScreen: React.FC = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.channelInfo}>
          <View style={styles.channelLeft}>
            <FontAwesomeIcon icon={faUsers} size={20} color="#FED7AA" />
            <View>
              <Text style={styles.channelTitle}>Fire Crew Alpha</Text>
              <Text style={styles.channelSubtitle}>4 firefighters online • Encrypted</Text>
            </View>
          </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.commsCard}>
          <Text style={styles.commsTitle}>Direct Comms: Mark Brown</Text>
          <View style={styles.commsButtons}>
            ...
            <TouchableOpacity style={styles.commsButton}>
              <View style={[styles.commsButtonIcon, styles.commsButtonIconOrange]}>
                <FontAwesomeIcon icon={faTowerBroadcast} size={18} color="#F97316" />
              </View>
        ...
        <View style={styles.chatContainer}>
          <View style={styles.chatHeader}>
            <Text style={styles.chatTitle}>Fire Channel</Text>
                    ...
                    {msg.type === 'audio' ? (
                      <View style={styles.audioMessage}>
                        <TouchableOpacity style={styles.playButton}>
                          <FontAwesomeIcon icon={faPlay} size={12} color="#F97316" />
                        </TouchableOpacity>
...
export default FireTeamRadioScreen;
