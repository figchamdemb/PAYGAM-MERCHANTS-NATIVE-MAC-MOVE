/**
 * ✅ PATROL APP - AMBULANCE/MEDICAL DASHBOARD SCREEN
 * Medical emergency response dashboard with sidebar menu
 * MFA Code: 000006
 */
...
const AmbulanceIcon: React.FC<{ size?: number; color?: string }> = ({ size = 24, color = '#FFFFFF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
    <Path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm4-9.5H7V6h3v3zm8 9.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm-1-9.5h-4V6h2.5l1.5 2v1z" />
  </Svg>
);

const HeartIcon: React.FC<{ size?: number; color?: string }> = ({ size = 24, color = '#FFFFFF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
...
const HospitalIcon: React.FC<{ size?: number; color?: string }> = ({ size = 24, color = '#FFFFFF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
    <Path d="M19 3H5c-1.1 0-1.99.9-1.99 2L3 19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 11h-4v4h-4v-4H6v-4h4V6h4v4h4v4z" />
  </Svg>
);

const VitalsIcon: React.FC<{ size?: number; color?: string }> = ({ size = 24, color = '#FFFFFF' }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
...
const AmbulanceDashboardScreen: React.FC = () => {
  ...
  const handleAcceptEmergency = () => {
    ...
    navigation.navigate('AmbulanceTaskDetails');
  };
      ...
      <Animated.View style={[styles.sidebar, { transform: [{ translateX: slideAnim }] }]}>
        <LinearGradient colors={['#1E293B', '#0F172A']} style={styles.sidebarGradient}>
          <View style={styles.sidebarHeader}>
            <View style={styles.sidebarProfile}>
              ...
              <View style={styles.sidebarProfileInfo}>
                <Text style={styles.sidebarName}>Paramedic Williams</Text>
                <Text style={styles.sidebarBadge}>Unit #EMS-105</Text>
              </View>
            </View>
          ...
          <View style={styles.menuSection}>
            ...
            <MenuItem icon={<QRCodeIcon size={20} color="#94A3B8" />} label="QR Scanner" onPress={() => { closeSidebar(); setTimeout(() => navigation.navigate('QRScanner', { department: 'ambulance' }), 300); }} />
            <MenuItem icon={<SettingsIcon size={20} color="#94A3B8" />} label="Settings" onPress={() => { closeSidebar(); setTimeout(() => navigation.navigate('Settings', { department: 'ambulance' }), 300); }} />
          </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <Text style={styles.officerName}>Paramedic Williams</Text>
          </View>
          <View style={styles.headerRight}>
            <View style={[styles.statusBadge, { backgroundColor: 'rgba(16,185,129,0.2)', borderColor: 'rgba(16,185,129,0.3)' }]}>
        ...
        <View style={styles.departmentBadge}>
          <LinearGradient colors={['#10B981', '#059669']} style={styles.departmentGradient}>
            <AmbulanceIcon size={24} color="#FFFFFF" />
            <Text style={styles.departmentText}>EMERGENCY MEDICAL UNIT</Text>
          </LinearGradient>
        </View>

        {/* Status Cards */}
        <View style={styles.statusRow}>
          <StatusCard label="Critical" value="1" color="#EF4444" />
          <StatusCard label="En Route" value="2" color="#F59E0B" />
        ...
        <View style={styles.activityCard}>
          <View style={styles.activityItem}>
            ...
            <View style={styles.activityContent}>
              <Text style={styles.activityTitle}>Cardiac Emergency - Downtown</Text>
              <Text style={styles.activityTime}>Active - 5 minutes ago</Text>
            </View>
          </View>
          <View style={styles.activityItem}>
            <View style={[styles.activityDot, { backgroundColor: '#10B981' }]} />
            <View style={styles.activityContent}>
              <Text style={styles.activityTitle}>Patient Transported - City Hospital</Text>
          ...
          <View style={styles.activityItem}>
            ...
            <View style={styles.activityContent}>
              <Text style={styles.activityTitle}>Trauma Response - Highway 7</Text>
      ...
      {showEmergencyAlert && (
        <Animated.View style={[styles.alertOverlay, { opacity: alertOpacity }]}>
          <Animated.View style={[styles.alertContainer, { transform: [{ scale: alertPulse }] }]}>
            <LinearGradient colors={['#065F46', '#064E3B']} style={styles.alertGradient}>
              <View style={styles.alertHeader}>
                <View style={styles.alertIconPulse}>
                  <Svg width={32} height={32} viewBox="0 0 24 24" fill="none">
                    <Path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" stroke="#FFFFFF" strokeWidth={2} fill="#EF4444" />
                  </Svg>
                </View>
                <Text style={styles.alertTitle}>🚑 MEDICAL EMERGENCY</Text>
              </View>
              <View style={styles.alertBody}>
                <Text style={styles.alertCode}>CODE 10-52</Text>
                <Text style={styles.alertType}>Cardiac Arrest</Text>
                <Text style={styles.alertLocation}>📍 Downtown Medical District</Text>
              ...
              <View style={styles.alertActions}>
                <TouchableOpacity style={styles.alertAcceptButton} onPress={handleAcceptEmergency}>
                  <LinearGradient colors={['#059669', '#047857']} style={styles.alertAcceptGradient}>
